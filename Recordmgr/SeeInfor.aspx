<%@ Page Title="查看登记情况" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="SeeInfor.aspx.cs" Inherits="DHMS.Recordmgr.SeeInfor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentMain" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="true" AutoGenerateColumns="False" BorderStyle="Solid" ShowHeaderWhenEmpty="True" Width="100%" OnPageIndexChanged="GridView1_PageIndexChanged" OnPageIndexChanging="GridView1_PageIndexChanging">
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="记录编号" DataNavigateUrlFormatString="./ModifyRecord.aspx?rid={0}" HeaderText="修改记录" DataTextField="记录编号" DataTextFormatString="修改记录" />
        </Columns>
    </asp:GridView>
</asp:Content>
