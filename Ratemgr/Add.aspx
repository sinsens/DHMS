<%@ Page Title="新建固定费率信息" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="DHMS.Ratemgr.Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentMain" runat="server">
    <table style="width: 100%;" border="1">
        <tr>
            <th colspan="3">新建固定费率信息</th>
        </tr>
        <tr>
            <td>显示名称</td>
            <td><asp:TextBox ID="tbName" MaxLength="32" runat="server" TabIndex="0"></asp:TextBox>;</td>
